...
const getCatergoriesFromData = (data: any) => {
  let temp: any = {};
...
const HomeScreen = ({navigation}: any) => {
  ...
  const [categories, setCategories] = useState(
    getCatergoriesFromData(CoffeeList),
  );
    ...
    <View style={styles.ScreenContainer}>
      ...
      <ScrollView
        ...
        <ScrollView
          ...
          contentContainerStyle={styles.CategoryScrollStyleView}>
        ...
        <FlatList
          ...
          renderItem={({item}) => {
            return (
              <TouchableOpacity
                onPress={() => {
                  navigation.push('Details',{index: item.index,
                    id: item.id,
                    type: item.type,});
                }}>
                <CoffeeCard
